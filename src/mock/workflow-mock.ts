...
export const WORFLOW_INTER_PIADA = {
  "documentos_anexados": [],
  "grafo": {
    "nos": [
      {
...
export const WORFLOW_MINUTA_INTERACAO_SEM_DOC = {
  "documentos_anexados": [],
  "grafo": {
    "nos": [
      {
    ...
    "arestas": [
      { "origem": "Análise da Auditoria", "destino": "Elaboração do Voto" },
      { "origem": "Análise das Defesas", "destino": "Elaboração do Voto" },
      { "origem": "Elaboração do Voto", "destino": "Extração de Dados Estruturados" },
      { "origem": "Extração de Dados Estruturados", "destino": "END" }
    ]
  },
  "formato_resultado_final": {
    "combinacoes": [
      {
        ...
        "combinar_resultados": ["analise_auditoria", "analises_defesas"],
        "manter_originais": false
      }
    ],
    "saidas_individuais": ["dados_estruturados", "voto_relator"]
  }
}

export const WORFLOW_MINUTA_INTERACAO_COM_DOC = {
  "documentos_anexados": [
    {
      "chave": "auditoria_especial",
      "descricao": "Relatorio auditoria_especial",
      "uuid_unico": "fa5962d6-a2ee-4494-91ab-4da738e10508"
    },
    {
      "chave": "defesas_do_caso",
      "descricao": "Relatorio defesa",
      "uuids_lista": [
        "d76c404e-aa48-4ba1-9776-3f7a33f5d13f",
        "b05fe56a-d3e9-4423-8560-e6e6982acd18",
        "33da6c9d-b6fb-4b53-9f86-b501e9b7dbfd"
      ]
    }
  ],
  "grafo": {
