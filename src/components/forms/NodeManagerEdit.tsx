...
type TabType = 'basic' | 'prompt' | 'documents' | 'inputs' | 'output' | 'interaction';

export default function NodeManagerEdit({ nodeId, onClose, onSubmit }: NodeManagerEditProps) {
    const {
        formData,
    ...
    // Carrega os dados do nó quando o componente é montado ou o nodeId muda
    useEffect(() => {
        if (nodeId) {
            loadNodeData(nodeId);
        }
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        handleSubmit(e);
        onSubmit?.(formData);
        onClose?.(); // Fecha o formulário após submit
    };
    ...
    const tabs = [
        { id: 'basic', label: 'Configurações Básicas' },
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                    {isEditing ? 'Editar Nó' : 'Criar Novo Nó'}
                </h3>
                <button
                    onClick={onClose}
            ...
            <form onSubmit={handleFormSubmit} className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div id="input-graph">
                                    ...
                                    <label className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                        ...
                                        />
                                        <span className="text-sm text-gray-700 dark:text-gray-300">Este nó é uma entrada de grafo</span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div id="input-text-prompt">
                            ...
                            <div className="flex justify-between items-center mt-1">
                                <p className="text-xs text-gray-500 dark:text-gray-400">
                                    Configure as entradas na aba "Entradas" e use o botão "Inserir Variável" para referenciar dados no prompt
                                </p>
                ...
                <div className="flex space-x-3 justify-end pt-4">
                    ...
                    >
                        {isEditing ? 'Atualizar Nó' : 'Criar Nó'}
                    </button>
                </div>
            </form>
        </div>
