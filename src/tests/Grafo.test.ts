...
describe('Grafo', () => {
  ...
  describe('validate()', () => {
    ...
    test('deve detectar nó inválido durante validação', () => {
      ...
      expect(() => grafoInvalido.validate()).toThrow('Nome do nó é obrigatório');
    });
  ...
  describe('Cenários Específicos', () => {
    ...
    test('deve validar grafo complexo com múltiplos caminhos', () => {
      const nodesComplexos = [
        new NodeEntitie('Início', 'Prompt início', false, { nome: 'inicio', formato: 'markdown' }, []),
        new NodeEntitie('Processo A', 'Prompt A', false, { nome: 'processo_a', formato: 'markdown' }, []),
        new NodeEntitie('Processo B', 'Prompt B', false, { nome: 'processo_b', formato: 'markdown' }, []),
        new NodeEntitie('Processo C', 'Prompt C', false, { nome: 'processo_c', formato: 'markdown' }, []),
        new NodeEntitie('Fim', 'Prompt fim', false, { nome: 'fim', formato: 'markdown' }, [])
      ];
